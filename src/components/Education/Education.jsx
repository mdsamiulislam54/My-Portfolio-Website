...
export default function EducationCards() {
    ...
    return (
        <section className=" custom-container py-16">
            <h3 className="text-3xl font-semibold mb-8 text-center">Education & Training</h3>
            ...
            >
                {cards.map((card) => (
                    <article
                        key={card.id}
                        className="flex flex-col bg-gradient-to-bl to-gray-800 from-black backdrop-blur-sm  shadow-md p-6 hover:shadow-lg transition-shadow duration-300 border-r border-yellow-500"
                    >
                        {/* Icon */}
